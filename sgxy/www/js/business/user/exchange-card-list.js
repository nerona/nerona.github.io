...
function pullUpAction () {
    ...
    business.cardList.pageNum = business.cardList.pageNum + business.cardList.pageSize;
    var param = {"shopId":business.cardList.shopId,"pageSize":business.cardList.pageSize,"pageNum":business.cardList.pageNum};
    Util.common.executeAjaxCallback(url, param, function(data){
        if(data.length>0){
