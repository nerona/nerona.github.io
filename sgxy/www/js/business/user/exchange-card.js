...
business.card={
    ...
    loadList:function(status){
        ...
        var param = {"vocherId":business.card.vocherId,"status":status,"pageSize":this.pageSize,"pageNum":this.pageNum};
...
document.addEventListener('DOMContentLoaded', function(){loaded("card_list")}, false);
var myScroll;
//下拉刷新
...
function pullUpAction () {
    var url = Util.common.baseUrl +"/mobile/voucher/getVoucherDetailList.do";
    business.card.pageNum = business.card.pageNum + business.card.pageSize;
    //status -1-全部 1-未兑换2-已兑换
    var param = {"vocherId":business.card.vocherId,"status":status,"pageSize":business.card.pageSize,"pageNum":business.card.pageNum};
    Util.common.executeAjaxCallback(url, param, function(data){
