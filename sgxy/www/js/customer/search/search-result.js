...
customer.search = {
    ...
    showClassify:function(obj){
        ...
        if(isdebug){
            //测试数据
            var data = [{"id":"1111111","name":getParameter("title")+1,"parentId":"238986851953229826" },
                {"id":"1111112","name":getParameter("title")+2,"parentId":"238986851953229826" },
                {"id":"1111113","name":getParameter("title")+3,"parentId":"238986851953229826" },
                {"id":"1111114","name":getParameter("title")+4,"parentId":"238986851953229826" }];
            //添加一条全部，全部默认为父节点
    ...
    initGoodList:function(){
        ...
        var conditionStr={"shopId":"","goodName":"","pageSize":"6","pageNum":"1","classifyId":"",
            "saleNumSort":"1","priceSort":"0","startPrice":"","endPrice":"","brandId":"","labelId":"",
            "columnId":Util.common.getParameter("classify")};
        var param = {"conditionStr":JSON.stringify(conditionStr)};
        Util.common.executeAjaxCallback(url, param, function (data) {
            customer.index.loadTemplate("#thelist", "#search_goodlist_t", data);
        });
    },
    //切换排序
