...
customer.details = {
    ...
    initEvent: function initEvent(data) {
        /*图片轮播*/
...
/*规格弹出窗口*/
$("#ggdialog").on({
    popupafteropen: function popupafteropen() {
        $("#ggdialog-popup").css({
...
//# sourceMappingURL=details-compiled.js.map