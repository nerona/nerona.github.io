...
customer.cart = {
    ...
    //删除购物车商品
    delCart: function delCart(goodsIds) {
    ...
    //修改购物车商品数量
    updateCart: function updateCart(count, goodIds, status) {
    ...
    //计算总金额
    doTotalMoney: function doTotalMoney() {
        var total = 0;
    ...
    doTotalMoneyOne: function doTotalMoneyOne() {
        var total = 0;
...
//# sourceMappingURL=shopping-cart-compiled.js.map