...
function goodSearchFocus() {
    ...
    for (var j = storage.length - 1; j >= 0; j--) {
        ...
        if (key.indexOf('search_') != -1) {
            ...
            var keystr = "'" + key + "'";
            var list = '<li><span onclick="searchHositoryClick(this)" style="width: 80%;display: inline-block;">' + value + '</span><span><a href="#" class="" onclick="goodSearchRemoveStroage(' + keystr + ',this)"></a></span></li>';
