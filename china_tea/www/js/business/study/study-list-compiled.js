...
business.study = {
    ...
    loadParentClassify: function loadParentClassify() {
    ...
    loadSecondClassify: function loadSecondClassify(obj, parentId) {
    ...
    classifyClick: function classifyClick(classifyId, classifName) {
    ...
    setCreateTimeOrder: function setCreateTimeOrder(obj) {
    ...
    setReadNumOrder: function setReadNumOrder(obj) {
...
//# sourceMappingURL=study-list-compiled.js.map