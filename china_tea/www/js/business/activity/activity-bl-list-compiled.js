...
business.activityList = {
    ...
    //初始化加载收藏列表
    loadList: function loadList(param) {
    ...
    queryByActivityStatus: function queryByActivityStatus(status) {
    ...
    toDetails: function toDetails(id, canEdit) {
    ...
    showDelDialog: function showDelDialog(id) {
        var that = this;
    ...
    closeDelDialog: function closeDelDialog() {
...
//# sourceMappingURL=activity-bl-list-compiled.js.map