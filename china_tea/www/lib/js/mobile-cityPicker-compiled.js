...
(function ($) {
	var scroll = {
		...
		fillHtml: function fillHtml(args) {
		...
		getText: function getText(args, val) {
			var citys = [];
	...
	$.extend({
		mobileCityPicker: function mobileCityPicker(option) {
			scroll.init($.extend({
				id: '',
...
//# sourceMappingURL=mobile-cityPicker-compiled.js.map