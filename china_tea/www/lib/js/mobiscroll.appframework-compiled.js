    ...
    (function ($) {
        ...
        ['width', 'height'].forEach(function (dimension) {
            $.fn[dimension] = function (value) {
                ...
                if (value === undefined) return this[0] == window ? document.documentElement['client' + Dimension] : this[0] == document ? Math.max(body['scroll' + Dimension], body['offset' + Dimension], html['client' + Dimension], html['scroll' + Dimension], html['offset' + Dimension]) : (offset = this.offset()) && offset[dimension];else return this.each(function (idx) {
                    var el = $(this);
...
//# sourceMappingURL=mobiscroll.appframework-compiled.js.map